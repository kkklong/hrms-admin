...
public class EmployeeBO {
    ...
    @Schema(type = "String",description = "信箱", pattern = VerificationRegexp.REGEXP_EMAIL, defaultValue = "fdsfdsfdsfs")
    ...
    @Schema(type = "Boolean", description = "是否將班表更新為新部門的預設班表")
    private Boolean updateShiftToDefault;

    @JsonFormat(shape = JsonFormat.Shape.STRING,pattern = "yyyy-MM-dd")
    @Schema(type = "Date",description = "入職時間yyyy-MM-dd")
    private LocalDate entryDate;

    @JsonFormat(shape = JsonFormat.Shape.STRING,pattern = "yyyy-MM-dd")
    @Schema(type = "Date",description = "離職時間yyyy-MM-dd")
